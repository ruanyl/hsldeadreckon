...
(function() {
  ...
  M.STMatching.prototype = {
    pointToSegCross: function(lng, lat, lng1, lat1, lng2, lat2) {
      ...
      if (cross <= 0) {
        var point = new M.Point(lng1, lat1);
      ...
      if (cross >= d2) {
        var point = new M.Point(lng2, lat2);
        point.originLongitude = lng;
        point.originLatitude = lat;
        point.isBreakpoint = true;
        return point;
      ...
      var point = new M.Point(pp[0], pp[1]);
      point.originLongitude = lng;
      point.originLatitude = lat;
